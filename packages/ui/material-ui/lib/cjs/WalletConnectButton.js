...
const WalletConnectButton = (_a) => {
    ...
    return (react_1.default.createElement(material_1.Button, Object.assign({ color: color, variant: variant, type: type, onClick: handleClick, disabled: disabled || !wallet || connecting || connected, startIcon: react_1.default.createElement(WalletIcon_js_1.WalletIcon, { wallet: wallet }) }, props), content));
};
