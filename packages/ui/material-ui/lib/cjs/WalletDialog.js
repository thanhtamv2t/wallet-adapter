...
const WalletDialog = (_a) => {
    ...
    const { open, setOpen } = (0, useWalletDialog_js_1.useWalletDialog)();
    ...
    return (react_1.default.createElement(RootDialog, Object.assign({ open: open, onClose: handleClose }, props),
        ...
        react_1.default.createElement(material_1.DialogContent, null,
            react_1.default.createElement(material_1.List, null,
                featured.map((wallet) => (react_1.default.createElement(WalletListItem_js_1.WalletListItem, { key: wallet.adapter.name, onClick: (event) => handleWalletClick(event, wallet.adapter.name), wallet: wallet }))),
                more.length ? (react_1.default.createElement(react_1.default.Fragment, null,
                    react_1.default.createElement(material_1.Collapse, { in: expanded, timeout: "auto", unmountOnExit: true },
                        react_1.default.createElement(material_1.List, null, more.map((wallet) => (react_1.default.createElement(WalletListItem_js_1.WalletListItem, { key: wallet.adapter.name, onClick: (event) => handleWalletClick(event, wallet.adapter.name), wallet: wallet }))))),
